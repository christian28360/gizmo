...
// alert("function getCookie"); utilisée
...
function montre(id) {
// alert("function montre"); utilisée
  if ( SiCookies )
  {
...
function cache_info() {
// alert("function cache_info");   utilisée
  document.getElementById("info").style.visibility = "hidden";
}
function montre_info() {
// alert("function montre_info");   utilisée
...
function GetId(id)
{
// alert("function GetId");   utilisée
  return document.getElementById(id);
}

function move(e) {
//  alert("function move"); utilisée
...
//  alert("function actualite");   utilisée
  // ICI ON METTRA LE TEXTE DE L'INFO BULLE A AFFICHER /
  if (Message == "actu")
  {
    var text = "";
    // redéfinission du stype liste à puce pour l'info-bulle :
    ...
    text += "</style>";
    text += "<b><span style='color: red;'>Bientôt :<br /> un moteur de recherche interne</span></b><hr />";
    text += "<b><u>Avril 2012</u></b>";
    text += "<ul><li>Nouveautés sur les cultures</li>";
    text += "<li>La philosophie du jardin naturel (accès par accueil)</li>";
    text += "</ul><hr />";
    text += "<b><u>Octobre/novembre 2011</u></b>";
    text += "<ul><li>Maladies et parasites</li></ul>";
    text += "<b><u>Juillet/août/septembre</u></b>";
    text += "<ul><li>Nouvelle rubrique : <strong>Cultures</strong></li></ul>";
    text += "<b><u>Nouveautés d'avril</u></b>";
    text += "<ul><li>Désherbage</li><li>Des recettes... pour vos plantes</li></ul>";
    text += "<hr /><b><u>25/12/2011 :</u></b>";
    text += "<ul><li>Des recettes pour les fêtes</li></ul>";
    text += "<hr><b><u>11/12/2010</u></b><p>Préparons la nouvelle année :</p>";
    text += "<ul><li>Le calendrier des travaux du jardin</li></ul>";
    text += "<b><u>Ajouté le 05/12/2010</u></b>";
    ...
    text += "<b><u>Ajouté le 11/11/2010</u></b>";
    text += "<ul><li>les traitements biologique</li>";
    text += "<li>liste des plantes sauvages avec renvoi sur l'article wikipédia</li";
    text += "<li>Liste des \"mauvaises herbes\"</li></ul>";
    text += "<hr><b>A venir :</b><b>Un forum pour vos échanges</b>";
  }
