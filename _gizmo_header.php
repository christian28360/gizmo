...
<div id="extruderLeft"
     class="{title:'Cliquez pour un accéder directement aux pages', url:('_gizmo_menu.html')}">
</div>
<table>
 <tbody>
  <tr>
...
<tbody>
 <tr>
  ...
  <!--  pseudo image pour activation si agrandissement, la source est mise à jour dans le script -->
...
echo "Vous êtes le " . number_format($cpt_visitors, 0, '', ' ') . "<sup>" . $s . "</sup> visiteur / ";
...
?>
   ...
   <a class="externe" href="http://anaisanaisduclosdichy.blogspot.fr/" target="_blank">
      Le blog de l'élevage dont je suis issu
   </a>
 </td>
 </tr>
</tbody>
